#include "circlepage.h"

void CirclePage::showListNoticeOfCircle(int n, QString circleName, QString comboBoxText, QString searchLineEdit, QTreeWidget* item, QVector<NoticeOfCircle>* noticeOfCircle)
{
...
void CirclePage::showScheduleOfCircle(QString date, QString circleName, QTreeWidget* item, QVector<ScheduleOfCircle>* scheduleOfCircle)
{
...
void CirclePage::showListBoardOfCircle(int n, QString circleName, QString comboBoxText, QString searchLineEdit, QTreeWidget* item, QVector<BoardOfCircle>* boardOfCircle)
{
...
void CirclePage::showListMemberOfCircle(int n, QString circleName, QString comboBoxText, QString searchLineEdit, QTreeWidget* item, QVector<MemberOfCircle>* memberOfCircle)
{
    ...
    if (memberCount.isOpen())
    {
        ...
        if (file.isOpen())
        {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                qDebug() << memberOfCircle->at(i).stuNum << memberOfCircle->at(i).name << memberOfCircle->at(i).stuYear << memberOfCircle->at(i).department << memberOfCircle->at(i).phoneNum << memberOfCircle->at(i).reason << memberOfCircle->at(i).promise << memberOfCircle->at(i).memberStatus;
            }
            file.close();
