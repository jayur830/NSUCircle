...
#include "../../NSUCircle/boarddialog.h"
...
QT_MOC_LITERAL(3, 33, 23) // "on_cancelButton_clicked"
    ...
    "BoardDialog\0on_okButton_clicked\0\0"
...
QT_INIT_METAOBJECT const QMetaObject BoardDialog::staticMetaObject = {
...
void *BoardDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui::BoardDialog"))
        return static_cast< Ui::BoardDialog*>(this);
